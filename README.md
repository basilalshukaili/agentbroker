...
| x402 payment rail | **Not offered.** The plumbing works and was proven once on Base mainnet (tx 0x38a0d9ec), then switched OFF: `/.well-known/x402` returns 404 and no tool returns 402. Card via Polar is the only rail. |
