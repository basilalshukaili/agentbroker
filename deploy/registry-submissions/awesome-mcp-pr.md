...
- [agent-broker](https://github.com/basilalshukaili/agentbroker) —
  Horizontal agent-to-business action layer. 20 tools for finding,
...
```
Add agent-broker (agent-to-business horizontal layer, 20 tools)
```
...
- 20 tools including import_booking_url (the differentiator)
