...
- [agent-broker](https://github.com/basilalshukaili/agentbroker) —
  Horizontal agent-to-business action layer. 21 tools for finding,
...
```
Add agent-broker (agent-to-business horizontal layer, 21 tools)
```
...
- 21 tools including import_booking_url (the differentiator)
