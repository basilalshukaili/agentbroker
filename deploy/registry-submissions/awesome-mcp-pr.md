...
- [agent-broker](https://github.com/basilalshukaili/agentbroker) —
  Horizontal agent-to-business action layer. 19 tools for finding,
...
```
Add agent-broker (agent-to-business horizontal layer, 19 tools)
```
...
- 19 tools including import_booking_url (the differentiator)
