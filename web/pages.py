...
<section class="section" id="how">
  ...
  <p class="lead">We expose the same 21 tools through every protocol agents speak today.</p>
  <div class="grid grid-3">
    <div class="card">
...
""" + f'<script>{_HOME_LIVE_JS}</script>'
    return page("Home", body, active="home",
                description=f"{BRAND} — horizontal MCP server. 21 tools, 7 discovery protocols, 26 jurisdictions, free tier for AI agents.")
